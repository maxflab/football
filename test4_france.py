...
"""
Created on Thu Dec 29 20:38:09 2022
...
for idx in match_ids:
    ...
    mask_england = (df.type_name == 'Pass') & (df.team_name == "France") & (df.index < sub) & (df.outcome_name.isnull()) & (df.sub_type_name != "Throw-in")
    #taking necessary columns
    df_pass = df.loc[mask_england, ['x', 'y', 'end_x', 'end_y', "player_name", "pass_recipient_name"]]
    all_passes = pd.concat([all_passes,df_pass])
